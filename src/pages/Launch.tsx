    ...
    <div className="launch-page" data-theme="tan">
      ...
      <div className="launch-container">
        ...
        <section id="streaks" className="launch-section">
          <h2 className="section-title">Streaks tracking</h2>
          <p>
            ...
            streak and tracking your longest streak using pure JavaScript date
            calculations—no AI needed.
          </p>
          <p>
            ...
            each day of the week, resetting every Sunday at 12:01 am. The bars
            use theme-specific colors matching your active date accent color for
            a cohesive visual experience across all themes.
          </p>
          <p>
            Click the fire icon to visit your dedicated streaks page with a
            two-column layout: the left column shows your streak statistics
            (current streak, longest streak, total completed, weekly calendar
            visualization, completion rate percentage, and next milestone
            progress), while the right column displays your personal stats
            (Todos Created, Completed, Active, Pinned, Archived, Full-Page
            Notes, Todo Notes, Pomodoro Sessions, and Folders).
          </p>
          <p>
          ...
          <p>
            ...
            for seamless integration with your preferred theme, and the app name
            "better todo" in the top left serves as a convenient back button to
            home. All streak data is user-scoped with complete privacy
            isolation—only you can see your progress. Toggle the streaks header
            visibility on or off with the Shift + S keyboard shortcut while
            keeping all streaks features fully functional. The app uses pure
            JavaScript for all streak calculations, requiring no AI API keys or
            external services.
          </p>
        </section>
