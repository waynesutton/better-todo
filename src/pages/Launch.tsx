...
export function Launch() {
  ...
  const sections = [
    ...
    { id: "streaks", title: "Streaks and AI badges" },
  ...
  return (
    <div className="launch-page" data-theme="tan">
      ...
      <div className="launch-container">
        ...
        <section id="streaks" className="launch-section">
          <h2 className="section-title">Streaks and AI badges</h2>
          <p>
            Track your todo completion momentum with automatic streak tracking
            that rewards consistency. Better-todo monitors when you complete all
            your regular date-based todos for each day, building your current
            streak and tracking your longest streak.
          </p>
          <p>
            A fire icon in the header displays your current streak with a 7-bar
            weekly progress indicator. Bars disappear as you complete todos for
            each day of the week, resetting every Sunday at 12:01 am. Click the
            fire icon to visit your dedicated streaks page with a HUD-inspired
            interface showing detailed stats: current streak, longest streak,
            total completed, weekly calendar visualization, completion rate
            percentage, and next milestone progress.
          </p>
          <p>
            Earn unique AI-generated achievement badges for milestones: First
            Step (complete your first todo), Day One Done (complete all todos
            for a single day), and streak milestones (3, 5, 7, 10, 30, 60, 90,
            365 days). Each badge is generated by OpenAI DALL-E 3 with a custom
            system prompt, creating grayscale geometric designs with 3D metallic
            rendering inspired by Fortnite-style rewards. All badges feature
            transparent backgrounds and randomized silhouettes, symbols, layer
            counts, and material finishes for a unique collectible experience.
          </p>
          <p>
            <strong>Badge milestones:</strong> First Step (1 todo) · Day One
            Done (1 day) · 3 Day Streak · 5 Day Streak · 7 Day Streak · 10 Day
            Streak · 30 Day Streak · 60 Day Streak · 90 Day Streak · 365 Day
            Streak (1 year!)
          </p>
          <p>
            The streaks page includes a year selector for viewing previous
            years' badges, a theme switcher in the top right, and uses the app
            name "better todo" in the top left as a back button to home. All
            data is user-scoped with complete privacy isolation. Toggle the
            streaks header on or off with Shift + S keyboard shortcut while
            keeping all streaks features fully functional.
          </p>
        </section>
