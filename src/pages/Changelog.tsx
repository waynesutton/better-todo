...
export function Changelog() {
  const [activeSection, setActiveSection] = useState("v007");
      ...
      <div className="launch-container">
        <section id="v007">
          ...
          <ul className="feature-list">
            ...
            <li>FilePlus icon to create new notes within full-page notes page</li>
        ...
        <section id="v006" className="launch-section">
          ...
          <ul className="feature-list">
            ...
            <li>More intuitive naming for organizing dates by project context</li>
          </ul>
        </section>
        ...
        <section id="v005" className="launch-section">
          ...
          <ul className="feature-list">
            ...
            <li>Screenshot galleries for themes, timer, mobile, and full-page notes</li>
        ...
        <section id="v004" className="launch-section">
          ...
          <ul className="feature-list">
            ...
            <li>Updated checkboxes, buttons, active states, and focus indicators</li>
        ...
        <section id="v001" className="launch-section">
          ...
          <p className="changelog-subtitle">Todo Text Font Size Customization</p>
          <p>
            Added user-specific font size settings for todo text with real-time
            preview.
          </p>
          <ul className="feature-list">
            <li>Font size options: 10px, 12px (default), 14px, 16px, 18px, 24px</li>
            <li>Settings accessible via Keyboard Shortcuts Modal (press ?)</li>
            <li>Font size persists across sessions and devices per user account</li>
